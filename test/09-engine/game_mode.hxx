...
void girl_game::on_render()
{
	...
	engine.render(*backgr->get_pawn_vbo(), backgr->get_pawn_texture(), scale1, cam->get_camera_matrix());
	...
	engine.render(*hero_contr->get_my_hero()->get_character_vbo(),
			hero_contr->get_my_hero()->get_character_texture(), m, cam->get_camera_matrix());
	...
	engine.render(*r_controller->get_rock()->get_pawn_vbo(),
			r_controller->get_rock()->get_pawn_texture(), m_r, cam->get_camera_matrix());
